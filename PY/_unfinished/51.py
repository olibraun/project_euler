...
# example having seven primes among the ten generated numbers, yielding the family: 56003, 56113, 56333, 56443, 56663, 56773, and 56993. 
...
primes = [x for x in range(1, 1000000) if OBMath.isPrime(x)]
